    ...
    <div class="sm:min-w-[560px] p-6 bg-white rounded shadow">
        <Form layout="vertical" @finish="enviarFormulario" :model="nino">
            ...
            <FormItem
                ...
                name="es_prematuro"
                :rules="[
                    { required: true, message: 'Indique si fue prematuro' },
                ]"
            >
                <RadioGroup
                    v-model:value="nino.es_prematuro"
                    @change="handlePrematuroChange"
                >
            ...
            <FormItem
                ...
                :rules="[
                    {
                        required: true,
                        message: 'Seleccione las semanas de gestación',
                    },
                ]"
            >
                <Select
            ...
            <FormItem
                ...
                name="peso"
                :rules="[
                    { required: true, message: 'Ingrese el peso al nacer' },
                ]"
            >
                <InputNumber
            ...
            <FormItem
                ...
                name="talla"
                :rules="[
                    { required: true, message: 'Ingrese la talla al nacer' },
                ]"
            >
                <InputNumber
            ...
            <div class="mt-4 flex justify-end gap-3">
                ...
                <Button type="primary" :loading="cargando" html-type="submit"
                    >Guardar Niño</Button
                >
            </div>
        </Form>
